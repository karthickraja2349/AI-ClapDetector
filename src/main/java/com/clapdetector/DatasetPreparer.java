...
// collect, process and dispatch to various processors via multiple threads . if any thread return false , the process will be stopped.
//without worrying about the audio data , we handover to the AudioDispatcherFactory for better dispatching.
